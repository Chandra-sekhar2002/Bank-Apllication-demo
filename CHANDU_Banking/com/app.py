from CHANDU_Banking.com.service.user_service import *
from CHANDU_Banking.com.service.banner_printing import *
...
while True:
    ...
    if userChoice == 1:
        ...
        # Function Responsible to create an account is called.
        ca = CreateAccount()
        ca.accountCreation()
        ...
        print()
        print("[+] Thank You for using CHANDU Bank, See you soon..")
        quit()
